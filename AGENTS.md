...
2. Every wave ends with: integration (merge worktrees) → build + tests → audit. The next wave starts only after the audit passes or records explicit exceptions in `.workflow/plan.md`.
